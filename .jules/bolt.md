...
## 2026-05-24 - [Extract Static Objects]
**Learning:** Functions that recreate large static objects (like configuration templates or nested translation data) on every invocation cause unnecessary memory reallocation and garbage collection (GC) overhead.
**Action:** Extract large static objects into module-level constants to prevent GC overhead in frequently called functions.
