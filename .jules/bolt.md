...
## 2026-05-21 - [Extract Static Configurations]
**Learning:** Instantiating large static objects like config dictionaries or templates inside frequently invoked functions like `generateWarmUp` or getters can lead to unnecessary memory re-allocations and garbage collector overhead.
**Action:** Extract nested static objects to the module level constants instead.
