...
## 2024-05-19 - Conditional DOM Updates in Iterative Renders
**Learning:** In hot render paths dealing with recycled DOM nodes, unconditionally assigning `node.textContent = value` can trigger expensive cross-boundary C++ operations and potential layout thrashing, even if the value hasn't changed.
